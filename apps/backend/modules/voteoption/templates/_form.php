...
<div class="sf_admin_form">
  <?php echo form_tag_for($form, '@vote_option') ?>
...
<table>
	...
	<tr>
      ...
      <td colspan="1"><label><?php echo $vote_option->getLastModifier() ?></label>
      </td>
    </tr>
	<tr>
      <td colspan="1"><label>Updated at:</label>
      </td>
      <td colspan="1"><label><?php echo $vote_option->getUpdatedAt() ?></label>
      </td>
    </tr>
</table>

    <?php include_partial('voteoption/form_actions', array('voteoption' => $vote_option, 'form' => $form, 'configuration' => $configuration, 'helper' => $helper)) ?>
  </form>
</div>
