...
<div class="sf_admin_form">
  <?php echo form_tag_for($form, '@theme') ?>
...
<table>
	...
	<tr>
      ...
      <td colspan="1"><label><?php echo $theme->getLastModifier() ?></label>
      </td>
    </tr>
	<tr>
      <td colspan="1"><label>Updated at:</label>
      </td>
      <td colspan="1"><label><?php echo $theme->getUpdatedAt() ?></label>
      </td>
    </tr>
</table>

    <?php include_partial('theme/form_actions', array('theme' => $theme, 'form' => $form, 'configuration' => $configuration, 'helper' => $helper)) ?>
  </form>
</div>
