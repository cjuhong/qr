...
<div class="sf_admin_form">
  <?php echo form_tag_for($form, '@app') ?>
...
<table>
	...
	<tr>
      ...
      <td colspan="1"><label><?php echo $app->getLastModifier() ?></label>
      </td>
    </tr>
	<tr>
      <td colspan="1"><label>Updated at:</label>
      </td>
      <td colspan="1"><label><?php echo $app->getUpdatedAt() ?></label>
      </td>
    </tr>
</table>

    <?php include_partial('app/form_actions', array('app' => $app, 'form' => $form, 'configuration' => $configuration, 'helper' => $helper)) ?>
  </form>
</div>
