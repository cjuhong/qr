...
/**
 * StatisticalDay filter form base class.
 *
 * @package    mgto
 * @subpackage filter
 ...
 */
abstract class BaseStatisticalDayFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('statistical_day_filters[%s]');
