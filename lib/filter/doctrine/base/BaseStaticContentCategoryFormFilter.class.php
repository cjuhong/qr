...
/**
 * StaticContentCategory filter form base class.
 *
 * @package    mgto
 * @subpackage filter
 ...
 */
abstract class BaseStaticContentCategoryFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('static_content_category_filters[%s]');
