...
/**
 * BookTranslation filter form base class.
 *
 * @package    mgto
 * @subpackage filter
 ...
 */
abstract class BaseBookTranslationFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('book_translation_filters[%s]');
