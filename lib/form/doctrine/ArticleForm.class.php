...
/******************************************************************/
    $this->widgetSchema['start_date']= new sfWidgetFormInputText(array('label' => 'Publish date'), array('size' => '100'));
    $this->widgetSchema['end_date']= new sfWidgetFormInputText(array('label' => 'End date'), array('size' => '100'));
    ...
    $this->validatorSchema->setPostValidator(
      new sfValidatorSchemaCompare('start_date', sfValidatorSchemaCompare::LESS_THAN_EQUAL, 'end_date',
                                   array(),
                                   array('invalid' => 'The publish date ("%left_field%") must be before the end date ("%right_field%")')
      ));
...
/************************************************************************/
      $this->widgetSchema['article_type_id'] =new sfWidgetFormInputText();
      $this->widgetSchema['article_type_id']->setAttribute('readonly', 'readonly');
      ...
      $this->widgetSchema['comment_date'] =new sfWidgetFormInputText();
      $this->widgetSchema['comment_date']->setAttribute('readonly', 'readonly');
      $this->widgetSchema['comment_user']->setAttribute('readonly', 'readonly');
      $this->widgetSchema['comment_content']->setAttribute('readonly', 'readonly');
