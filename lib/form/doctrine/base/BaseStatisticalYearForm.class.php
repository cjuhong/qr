...
/**
 * StatisticalYear form base class.
 *
 * @method StatisticalYear getObject() Returns the current form's model object
 *
 * @package    mgto
 * @subpackage form
 ...
 */
abstract class BaseStatisticalYearForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('statistical_year[%s]');
