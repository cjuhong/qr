...
/**
 * ModuleTranslation form base class.
 *
 * @method ModuleTranslation getObject() Returns the current form's model object
 *
 * @package    mgto
 * @subpackage form
 ...
 */
abstract class BaseModuleTranslationForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('module_translation[%s]');
