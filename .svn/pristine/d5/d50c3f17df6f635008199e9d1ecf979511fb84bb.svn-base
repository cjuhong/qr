...
<div class="sf_admin_form">
  <?php echo form_tag_for($form, '@static_content') ?>
...
<table>
	...
	<tr>
      ...
      <td colspan="1"><label><?php echo $static_content->getLastModifier() ?></label>
      </td>
    </tr>
	<tr>
      <td colspan="1"><label>Updated at:</label>
      </td>
      <td colspan="1"><label><?php echo $static_content->getUpdatedAt() ?></label>
      </td>
    </tr>
</table>

    <?php include_partial('staticcontent/form_actions', array('staticcontent' => $static_content, 'form' => $form, 'configuration' => $configuration, 'helper' => $helper)) ?>
  </form>
</div>
