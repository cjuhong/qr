...
/**
 * StatisticalYear filter form base class.
 *
 * @package    mgto
 * @subpackage filter
 ...
 */
abstract class BaseStatisticalYearFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('statistical_year_filters[%s]');
