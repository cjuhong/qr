...
<div class="sf_admin_form">
  <?php echo form_tag_for($form, '@app_intro') ?>
...
<table>
	...
	<tr>
      ...
      <td colspan="1"><label><?php echo $app_intro->getLastModifier() ?></label>
      </td>
    </tr>
	<tr>
      <td colspan="1"><label>Updated at:</label>
      </td>
      <td colspan="1"><label><?php echo $app_intro->getUpdatedAt() ?></label>
      </td>
    </tr>
</table>

    <?php include_partial('appintro/form_actions', array('appintro' => $app_intro, 'form' => $form, 'configuration' => $configuration, 'helper' => $helper)) ?>
  </form>
</div>
