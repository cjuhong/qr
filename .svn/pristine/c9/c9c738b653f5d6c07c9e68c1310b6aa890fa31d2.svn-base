...
<div class="sf_admin_form">
  <?php echo form_tag_for($form, '@article_type') ?>
...
<table>
	...
	<tr>
      ...
      <td colspan="1"><label><?php echo $article_type->getLastModifier() ?></label>
      </td>
    </tr>
	<tr>
      <td colspan="1"><label>Updated at:</label>
      </td>
      <td colspan="1"><label><?php echo $article_type->getUpdatedAt() ?></label>
      </td>
    </tr>
</table>

    <?php include_partial('articletype/form_actions', array('articletype' => $article_type, 'form' => $form, 'configuration' => $configuration, 'helper' => $helper)) ?>
  </form>
</div>
