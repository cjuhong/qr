...
/**
 * ModuleCategoryTranslation form base class.
 *
 * @method ModuleCategoryTranslation getObject() Returns the current form's model object
 *
 * @package    mgto
 * @subpackage form
 ...
 */
abstract class BaseModuleCategoryTranslationForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('module_category_translation[%s]');
  ...
  {
    return 'ModuleCategoryTranslation';
  }
