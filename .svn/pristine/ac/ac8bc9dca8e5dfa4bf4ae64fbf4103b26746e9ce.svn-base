...
/**
 * ModuleCategoryTranslation filter form base class.
 *
 * @package    mgto
 * @subpackage filter
 ...
 */
abstract class BaseModuleCategoryTranslationFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('module_category_translation_filters[%s]');
