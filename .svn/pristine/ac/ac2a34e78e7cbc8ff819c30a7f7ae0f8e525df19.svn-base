...
/**
 * ModuleTranslation filter form base class.
 *
 * @package    mgto
 * @subpackage filter
 ...
 */
abstract class BaseModuleTranslationFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('module_translation_filters[%s]');
