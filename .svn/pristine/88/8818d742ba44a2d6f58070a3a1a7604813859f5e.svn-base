...
<div class="sf_admin_form">
  <?php echo form_tag_for($form, '@vote_options') ?>
...
<table>
	...
	<tr>
      ...
      <td colspan="1"><label><?php echo $vote_options->getLastModifier() ?></label>
      </td>
    </tr>
	<tr>
      <td colspan="1"><label>Updated at:</label>
      </td>
      <td colspan="1"><label><?php echo $vote_options->getUpdatedAt() ?></label>
      </td>
    </tr>
</table>

    <?php include_partial('voteoptions/form_actions', array('vote_options' => $vote_options, 'form' => $form, 'configuration' => $configuration, 'helper' => $helper)) ?>
  </form>
</div>
