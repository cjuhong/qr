...
/**
 * VoteOption filter form base class.
 *
 * @package    mgto
 * @subpackage filter
 ...
 */
abstract class BaseVoteOptionFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('vote_option_filters[%s]');
