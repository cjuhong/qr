...
/**
 * VoteOption form base class.
 *
 * @method VoteOption getObject() Returns the current form's model object
 *
 * @package    mgto
 * @subpackage form
 ...
 */
abstract class BaseVoteOptionForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('vote_option[%s]');
