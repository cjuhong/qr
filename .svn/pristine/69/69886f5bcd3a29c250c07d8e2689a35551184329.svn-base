...
<div class="sf_admin_form">
  <?php echo form_tag_for($form, '@module_category') ?>
...
<table>
	...
	<tr>
      ...
      <td colspan="1"><label><?php echo $module_category->getLastModifier() ?></label>
      </td>
    </tr>
	<tr>
      <td colspan="1"><label>Updated at:</label>
      </td>
      <td colspan="1"><label><?php echo $module_category->getUpdatedAt() ?></label>
      </td>
    </tr>
</table>

    <?php include_partial('modulecategory/form_actions', array('modulecategory' => $module_category, 'form' => $form, 'configuration' => $configuration, 'helper' => $helper)) ?>
  </form>
</div>
