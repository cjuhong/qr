...
/**
 * ModuleCategory filter form base class.
 *
 * @package    mgto
 * @subpackage filter
 ...
 */
abstract class BaseModuleCategoryFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('module_category_filters[%s]');
