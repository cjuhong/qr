...
/**
 * AppTranslation form base class.
 *
 * @method AppTranslation getObject() Returns the current form's model object
 *
 * @package    mgto
 * @subpackage form
 ...
 */
abstract class BaseAppTranslationForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('app_translation[%s]');
