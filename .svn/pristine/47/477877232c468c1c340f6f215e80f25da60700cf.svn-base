...
<table>
	...
	<tr>
      ...
      <td colspan="1"><label><?php echo $banner->getLastModifier() ?></label>
      </td>
    </tr>
	<tr>
      <td colspan="1"><label>Updated at:</label>
      </td>
      <td colspan="1"><label><?php echo $banner->getUpdatedAt() ?></label>
      </td>
    </tr>
</table>

    <?php include_partial('banner/form_actions', array('banner' => $banner, 'form' => $form, 'configuration' => $configuration, 'helper' => $helper)) ?>
  </form>
</div>
