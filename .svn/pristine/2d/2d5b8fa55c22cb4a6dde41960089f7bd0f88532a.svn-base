 ...
 */
class AppTranslationForm extends BaseAppTranslationForm
{
  public function configure()
  {
    $this->widgetSchema['name'] = new sfWidgetFormInputText(array('label' => 'Name'), array('size' => '100'));
    $this->widgetSchema['introduction'] = new sfWidgetFormTextareaTinyMce1(array('label' => 'Introduction'), array('rows' => '25', 'cols' =>'100'));
