...
/**
 * UserOption filter form base class.
 *
 * @package    mgto
 * @subpackage filter
 ...
 */
abstract class BaseUserOptionFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'option_id'     => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('VoteOptions'), 'column' => 'id')),
    ...
    $this->widgetSchema->setNameFormat('user_option_filters[%s]');
