...
/**
 * ModuleCategory form base class.
 *
 * @method ModuleCategory getObject() Returns the current form's model object
 *
 * @package    mgto
 * @subpackage form
 ...
 */
abstract class BaseModuleCategoryForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('module_category[%s]');
