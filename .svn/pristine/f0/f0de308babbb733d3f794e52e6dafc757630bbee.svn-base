...
/**
 * AppIntro filter form base class.
 *
 * @package    mgto
 * @subpackage filter
 ...
 */
abstract class BaseAppIntroFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'company_name'  => new sfWidgetFormFilterInput(),
      'app_logo'      => new sfWidgetFormFilterInput(),
      'app_capture'   => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'app_logo'      => new sfValidatorPass(array('required' => false)),
      'app_capture'   => new sfValidatorPass(array('required' => false)),
    ...
    $this->widgetSchema->setNameFormat('app_intro_filters[%s]');
