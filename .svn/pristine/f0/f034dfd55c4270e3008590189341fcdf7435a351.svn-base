...
/**
 * StatisticalDay form base class.
 *
 * @method StatisticalDay getObject() Returns the current form's model object
 *
 * @package    mgto
 * @subpackage form
 ...
 */
abstract class BaseStatisticalDayForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('statistical_day[%s]');
