...
abstract class BaseBannerGroupForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'banner_width'  => new sfWidgetFormInputText(),
      'banner_height' => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'banner_width'  => new sfValidatorString(array('max_length' => 100, 'required' => false)),
      'banner_height' => new sfValidatorString(array('max_length' => 100, 'required' => false)),
