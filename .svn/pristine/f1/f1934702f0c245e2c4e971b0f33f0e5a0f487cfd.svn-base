...
<div class="sf_admin_form">
  <?php echo form_tag_for($form, '@book') ?>
...
<table>
	...
	<tr>
      ...
      <td colspan="1"><label><?php echo $book->getLastModifier() ?></label>
      </td>
    </tr>
	<tr>
      <td colspan="1"><label>Updated at:</label>
      </td>
      <td colspan="1"><label><?php echo $book->getUpdatedAt() ?></label>
      </td>
    </tr>
</table>

    <?php include_partial('book/form_actions', array('book' => $book, 'form' => $form, 'configuration' => $configuration, 'helper' => $helper)) ?>
  </form>
</div>
